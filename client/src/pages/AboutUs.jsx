...
import subh from "../assets/pictures/subh.jpeg";
		...
		<div>
			...
			>
				...
				<div className="abtCol2 d-flex flex-column align-items-start ms-5">
					<h1>ASHRAY</h1>
					<p className="mt-4">
						The word ‘Ashray’ when literally translated from its
						colloquial form to English means ‘shelter’.
					</p>
					<p className="mt-2">
						With Ashray we aim at bringing all the various NGOs and
					...
					<div className="abtTeam d-flex mt-4">
						...
						<img src={subh} alt="" className="abtMembers mx-2" />
